...
func TestHKDFBasic(t *testing.T) {
	...
	var tests = []struct {
	...
	}{
		{
			...
			fips:    false, // Not FIPS-compliant because salt is too short.
		},
		{
			name:    "TestCase2",
		...
		},
		{
			...
			fips: false, // Not FIPS-compliant because salt/info are too short.
		},
		{
			name:    "TestCase4",
			...
			fips:    false, // Not FIPS-compliant because of use of SHA1 and short key material.
		},
		{
			name:    "TestCase5",
			...
			fips: false, // Not FIPS-compliant because of use of SHA1.
		},
		{
			name:    "TestCase6",
